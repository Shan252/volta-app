...
import com.example.financemanagementclient.databinding.ActivityViewPaymentBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.searchButton.setOnClickListener {
            ...
            if  (searchID.isNotEmpty()){
                ...
                Toast.makeText(this,"Please enter Payment ID",Toast.LENGTH_SHORT).show()
            }
        }
    }
    private fun readData(id: String){
        ...
        databaseReference.child(id).get().addOnSuccessListener {
            if (it.exists()){
                ...
                Toast.makeText(this,"Payment ID does not exist", Toast.LENGTH_SHORT).show()
            }
